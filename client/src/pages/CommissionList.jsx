    ...
    <div>
      ...
      <div className="commissions">
        <h1>Commission List</h1>
                ...
                <Table
                    headers={['ID', 'Title', 'Employer', 'Type', 'Payment', 'Posted', 'Completed', 'Status', 'Action']}
                    data={currentItems.map(Commission => ([
                        ...
                        <>
                            <button onClick={() => handleDelete(Commission.commissionID)}>X</button>
                            <button className='update'>
                                <Link to={`/update-commission/${Commission.commissionID}`}>View</Link>
                            </button>
                        </>
                    ]))}
                />
